            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="shortlink" value="{{ old('shortlink')??$data->shortlink }}" class="form-control" placeholder="custom-link">
                </div>
              </div>
              <div class="form-group">
                <label for="destination">Link Tujuan</label>
                <textarea name="destination" rows="5" class="form-control">{{ old('destination')??$data->destination }}</textarea>
              </div>
              <div class="form-group">
